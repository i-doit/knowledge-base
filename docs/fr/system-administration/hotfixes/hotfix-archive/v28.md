...
### Lors de l'ouverture d'une page d'aperçu d'objet, une erreur HTTP 500 apparaît 

### Lors de l'ouverture de la configuration de la vue en liste d'un type d'objet, une erreur HTTP 500 apparaît 
...
### Les notifications basées sur les rapports ne seront pas envoyées même si le rapport contient des résultats 
...
### Importation CSV crée un objet avec un mauvais type d'objet 
...
### Ne pas utiliser l'adresse MAC pour la correspondance si elle est nulle (JDisc) 
