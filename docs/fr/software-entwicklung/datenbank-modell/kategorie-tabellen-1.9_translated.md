...
| Auf Gerät | int | isys_catg_drive_list | isys_catg_drive_list__isys_catg_raid_list__id | isys_catg_raid_list | isys_catg_raid_list__id |
| Auf Gerät | int | isys_catg_drive_list | isys_catg_drive_list__isys_catg_ldevclient_list__id | isys_catg_ldevclient_list | isys_catg_ldevclient_list__id |
| Konstante | text | isys_catg_drive_list | isys_catg_drive_list__const |     |     |
...
| sur le périphérique | int | isys_catg_drive_list | isys_catg_drive_list__isys_catg_stor_list__id | isys_catg_stor_list | isys_catg_stor_list__id |
| Sur le périphérique | int | isys_catg_drive_list | isys_catg_drive_list__isys_catg_raid_list__id | isys_catg_raid_list | isys_catg_raid_list__id |
| sur le périphérique | int | isys_catg_drive_list | isys_catg_drive_list__isys_catg_ldevclient_list__id | isys_catg_ldevclient_list | isys_catg_ldevclient_list__id |
| constante | texte | isys_catg_drive_list | isys_catg_drive_list__const | |
...
| interface | int | isys_catg_connector_list | isys_catg_connector_list__isys_interface__id | isys_interface | isys_interface__id |
| fibre / longueurs d'onde | int | fiber_wave_lengths | isys_catg_connector_list__id | isys_catg_connector_list_2_isys_fiber_wave_length | isys_catg_connector_list__id |
...
| Feld | Typ | Tabelle | Datenbank-Feld | Referenz-Tabelle | Referenz |
| --- | --- | --- | --- | --- | --- |
| Virtueller Host | int | isys_catg_virtual_host_list | isys_catg_virtual_host_list__virtual_host |     |     |
...
| champ | type | table | champ de base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
| hôte virtuel | int | isys_catg_virtual_host_list | isys_catg_virtual_host_list__virtual_host | |
...
| Telefonrate | int | isys_catg_sim_card_list | isys_catg_sim_card_list__isys_telephone_rate__id | isys_telephone_rate | isys_telephone_rate__id |
...
| taux de téléphone | int | isys_catg_sim_card_list | isys_catg_sim_card_list__isys_telephone_rate__id | isys_telephone_rate | isys_telephone_rate__id |
...
| description (carte twin) (carte twin) | text_area | isys_catg_sim_card_list | isys_catg_sim_card_list__optional_info | |
...
### LC__CATG__CMK_FOLDER

### LC__CATG__CMK_FOLDER

#### Tabelle: isys_catg_cmk_list

#### Tableau : isys_catg_cmk_list

| Feld | Typ | Tabelle | Datenbank-Feld | Referenz-Tabelle | Referenz |
| --- | --- | --- | --- | --- | --- |
| LC__CATG__CMK__ACTIVE | int | isys_catg_cmk_list | isys_catg_cmk_list__exportable |     |     |
| Exportkonfiguration | int | isys_catg_cmk_list | isys_catg_cmk_list__isys_monitoring_export_config__id |     |     |
| LC__CATG__CMK__ALIAS | text | isys_catg_cmk_list | isys_catg_cmk_list__title |     |     |
| LC__CATG__CMK__EXPORT_IP | int | isys_catg_cmk_list | isys_catg_cmk_list__export_ip |     |     |
| Hostadresse | int | isys_catg_cmk_list | isys_catg_cmk_list__isys_catg_ip_list__id |     |     |
| LC__CATG__CMK__HOSTNAME | text | isys_catg_cmk_list | isys_catg_cmk_list__host_name |     |     |
| LC__CATG__CMK__HOSTNAME | int | isys_catg_cmk_list | isys_catg_cmk_list__host_name_selection |     |     |
| Beschreibung | text_area | isys_catg_cmk_list | isys_catg_cmk_list__description |     |     |

| champ | type | table | champ de base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
| LC__CATG__CMK__ACTIVE | int | isys_catg_cmk_list | isys_catg_cmk_list__exportable | |
| configuration d'exportation | int | isys_catg_cmk_list | isys_catg_cmk_list__isys_monitoring_export_config__id | |
| LC__CATG__CMK__ALIAS | texte | isys_catg_cmk_list | isys_catg_cmk_list__title | |
| LC__CATG__CMK__EXPORT_IP | int | isys_catg_cmk_list | isys_catg_cmk_list__export_ip | |
| adresse de l'hôte | int | isys_catg_cmk_list | isys_catg_cmk_list__isys_catg_ip_list__id | |
| LC__CATG__CMK__HOSTNAME | texte | isys_catg_cmk_list | isys_catg_cmk_list__nom_d'hôte | |
| LC__CATG__CMK__HOSTNAME | int | isys_catg_cmk_list | isys_catg_cmk_list__host_name_selection | |
| description | text_area | isys_catg_cmk_list | isys_catg_cmk_list__description | |

### LC__CATG__CMK_TAG

### LC__CATG__CMK_TAG

#### Tabelle: isys_catg_cmk_tag_list

#### Tableau : isys_catg_cmk_tag_list

| Feld | Typ | Tabelle | Datenbank-Feld | Referenz-Tabelle | Referenz |
| --- | --- | --- | --- | --- | --- |
| LC__CATG__CMK_TAG__TAGS | text | isys_catg_cmk_tag_list | isys_catg_cmk_tag_list__tags |     |     |
| Beschreibung | text_area | isys_catg_cmk_tag_list | isys_catg_cmk_tag_list__description |     |     |

| champ | type | table | champ de base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
| LC__CATG__CMK_TAG__TAGS | texte | isys_catg_cmk_tag_list | isys_catg_cmk_tag_list__tags | |
| description | text_area | isys_catg_cmk_tag_list | isys_catg_cmk_tag_list__description | |

### LC__CATG__CMK_HOST_SERVICE

### LC__CATG__CMK_HOST_SERVICE

#### Tabelle: isys_catg_cmk_host_service_list

#### Tableau : isys_catg_cmk_host_service_list

| Feld | Typ | Tabelle | Datenbank-Feld | Referenz-Tabelle | Referenz |
| --- | --- | --- | --- | --- | --- |
| LC__CATG__CMK_SERVICE__CHECK_MK_SERVICES | text | isys_catg_cmk_host_service_list | isys_catg_cmk_host_service_list__service |     |     |
| LC__CATG__CMK_SERVICE__SOFTWARE_ASSIGNMENT | int | isys_catg_cmk_host_service_list | isys_catg_cmk_host_service_list__application__id | isys_catg_application_list | isys_catg_application_list__id |
| Beschreibung | text_area | isys_catg_cmk_host_service_list | isys_catg_cmk_host_service_list__description |     |     |

| champ | type | table | champ de base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
| LC__CATG__CMK_SERVICE__CHECK_MK_SERVICES | texte | isys_catg_cmk_host_service_list | isys_catg_cmk_host_service_list__service | |
| LC__CATG__CMK_SERVICE__SOFTWARE_ASSIGNMENT | int | isys_catg_cmk_host_service_list | isys_catg_cmk_host_service_list__application__id | isys_catg_application_list | isys_catg_application_list__id |
| description | text_area | isys_catg_cmk_host_service_list | isys_catg_cmk_host_service_list__description | |

### LC__CATG__CMK_SERVICE

### LC__CATG__CMK_SERVICE

#### Tabelle: isys_catg_cmk_service_list

#### Tableau : isys_catg_cmk_service_list

| Feld | Typ | Tabelle | Datenbank-Feld | Referenz-Tabelle | Referenz |
| --- | --- | --- | --- | --- | --- |
| LC__MODULE__CHECK_MK__HOST | int | isys_catg_cmk_service_list | isys_catg_cmk_service_list__host |     |     |
| LC__CATG__CMK_SERVICE__CHECK_MK_SERVICES | text | isys_catg_cmk_service_list | isys_catg_cmk_service_list__service |     |     |
| Beschreibung | text_area | isys_catg_cmk_service_list | isys_catg_cmk_service_list__description |     |     |

| champ | type | table | champ de base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
| LC__MODULE__CHECK_MK__HOST | int | isys_catg_cmk_service_list | isys_catg_cmk_service_list__host | |
| LC__CATG__CMK_SERVICE__CHECK_MK_SERVICES | texte | isys_catg_cmk_service_list | isys_catg_cmk_service_list__service | |
| description | text_area | isys_catg_cmk_service_list | isys_catg_cmk_service_list__description | |
...
| Länge in CM | float | isys_catg_cable_list | isys_catg_cable_list__length |     |     |
...
| Verbindung | text | isys_catg_cable_list | isys_catg_cable_list__id__isys_obj__id |     |     |
...
| longueur en CM | float | isys_catg_cable_list | isys_catg_cable_list__length | |
...
| connexion | texte | isys_catg_cable_list | isys_catg_cable_list__id__isys_obj__id | |
...
| champ | type | table | champ de la base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
...
| Volumen-Einheit | int | isys_cats_ac_list | isys_cats_ac_list__isys_ac_air_quantity_unit__id | isys_ac_air_quantity_unit | isys_ac_air_quantity_unit__id |
...
| Maßeinheit | int | isys_cats_ac_list | isys_cats_ac_list__isys_depth_unit__id | isys_depth_unit | isys_depth_unit__id |
...
| unité de volume | int | isys_cats_ac_list | isys_cats_ac_list__isys_ac_air_quantity_unit__id | isys_ac_air_quantity_unit | isys_ac_air_quantity_unit__id |
...
| unité de mesure | int | isys_cats_ac_list | isys_cats_ac_list__isys_depth_unit__id | isys_depth_unit | isys_depth_unit__id |
...
| Feld | Typ | Tabelle | Datenbank-Feld | Referenz-Tabelle | Referenz |
| --- | --- | --- | --- | --- | --- |
| Bezeichnung | int | isys_catg_contact_list | isys_catg_contact_list__isys_obj__id |     |     |
| Rolle | int | isys_catg_contact_list | isys_catg_contact_list__isys_contact_tag__id | isys_contact_tag | isys_contact_tag__id |

| champ | type | table | champ de base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
| description | int | isys_catg_contact_list | isys_catg_contact_list__isys_obj__id | |
| rôle | int | isys_catg_contact_list | isys_catg_contact_list__isys_contact_tag__id | isys_contact_tag | isys_contact_tag__id |
...
| Feld | Typ | Tabelle | Datenbank-Feld | Referenz-Tabelle | Referenz |
| --- | --- | --- | --- | --- | --- |
| Objekt | int | isys_catg_contact_list | isys_catg_contact_list__isys_obj__id | isys_connection | isys_connection__isys_obj__id |
...
| champ | type | table | champ de base de données | table de référence | référence |
| --- | --- | --- | --- | --- | --- |
| objet | int | isys_catg_contact_list | isys_catg_contact_list__isys_obj__id | isys_connection | isys_connection__isys_obj__id |
...
| prochaine date possible de résiliation | texte | isys_cats_contract_list | isys_cats_contract_list__id | |
| date de résiliation | isys_cats_contract_list | isys_cats_contract_list__notice_date | |
