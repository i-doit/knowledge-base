...
- **Locations:** Buildings, rooms, racks — hierarchically structured with a visual [rack view](../grundlagen/kategorien/s-enclosure.md)

### Mapping relationships

In reality, no system stands alone. A web server needs a database server, runs on a VM that runs on a host in a rack. i-doit maps these dependencies as **object relationships** — and makes them visually visible in the [CMDB Explorer](../auswertungen/cmdb-explorer/index.md).
...
Whether ISO 27001, BSI IT-Grundschutz, or internal audits — an up-to-date CMDB provides the data that auditors want to see. i-doit documents not only the current state but also the [lifecycle](../grundlagen/lebens-und-dokumentationszyklus.md) of every component.

### Automating processes

Via the [API](../i-doit-add-ons/api/index.md) and [interfaces](../automatisierung-und-integration/index.md), i-doit can be integrated into existing workflows: Monitoring systems like Checkmk report status changes, service desk systems reference CMDB objects, JDisc Discovery automatically populates the documentation via network scans.
...
More on this: [Concepts and terminology](konzepte-und-begriffe.md)
...
| **Automation** | [Cronjobs](../wartung-und-betrieb/cronjobs-einrichten.md) + Console | [Flows Lite](../idoit-cloud/index.md#automatisierung-mit-flows-lite) |
...
3. **Set up:** Read [How do I start documenting?](wie-beginne-ich-zu-dokumentieren.md)
4. **Plan:** Work through the [IT documentation checklist](checkliste-fuer-die-it-dokumentation.md)
5. **Learn:** [Basics](../grundlagen/index.md) — Understand objects, categories, and lists

## See also

- [How do I start documenting?](wie-beginne-ich-zu-dokumentieren.md) — Step by step to your first documentation
- [IT documentation checklist](checkliste-fuer-die-it-dokumentation.md) — All important points at a glance
- [Concepts and terminology](konzepte-und-begriffe.md) — Objects, categories, attributes, and relationships explained
- [Glossary](../glossar.md) — Terms related to i-doit
