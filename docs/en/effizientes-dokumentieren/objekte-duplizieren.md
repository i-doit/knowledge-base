...
With the duplicate function, you quickly create a copy of an existing [object](../grundlagen/struktur-it-dokumentation.md) in i-doit -- including the desired category contents.
...
5. Define which contents should be transferred: the [specific category](../glossar.md) (if available) as well as the [categories](../glossar.md) linked to the object type.
