...
| -------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| admin    | admin    | Admin    | All permissions, including for the [Administration](../../administration/verwaltung/index.md)     |
| archivar | archivar | Archivar | Read and edit                                                                                     |
| author   | author   | Author   | Create, edit, [archive](../../grundlagen/lebens-und-dokumentationszyklus.md), and execute         |
...
!!! success "Link permissions to LDAP/AD"
    As described in the article on [initial login](../../grundlagen/erstanmeldung.md), it makes sense to automate persons and group memberships by connecting to an [LDAP directory server/Active Directory (AD)](../../benutzerauthentifizierung-und-verwaltung/ldap-verzeichnis/index.md).
...
Example: Person X is in the **Reader** group and can therefore read everything in i-doit, but not edit. Additionally, they receive the permission to create their own [reports](../../auswertungen/report-manager.md). This permission complements the permissions of the **Reader** group.
