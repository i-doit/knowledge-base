...
List editing is a function that enables the simultaneous and easy editing of multiple [objects](../grundlagen/struktur-it-dokumentation.md). Editing is performed per [category](../grundlagen/struktur-it-dokumentation.md).
...
Alternatively, you can access list editing by selecting the checkboxes of multiple objects within an [object list](../grundlagen/objekt-liste/index.md) and then using the **Edit** button.
...
If you access list editing via the Extras menu, you can select the objects to edit in the next step. Additionally, you can specify which [category](../grundlagen/struktur-it-dokumentation.md) you want to edit.
...
Changes within a row of an object only change the [attribute](../grundlagen/struktur-it-dokumentation.md) of that object. Changes in the top row assign the same value to all objects for the selected attribute. These are applied as soon as you use the **Save** button.
