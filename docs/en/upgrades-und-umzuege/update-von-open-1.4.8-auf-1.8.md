...
The subsequent update procedure corresponds to the normal [update via the Web GUI](../wartung-und-betrieb/update-einspielen.md). Since major updates cannot be skipped, you apply the versions one after another:
