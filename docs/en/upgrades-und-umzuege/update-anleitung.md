...
!!! attention "Release notes"
    Read the [release notes](../versionshistorie/index.md) before updating to a new version.
...
!!! attention "Hotfix note"
    ...
    Since these are hotfixes, we recommend installing them only if the adjustments are required for smooth operation of your installation or if you are requested to do so by the support team. Make sure you have created a [backup of i-doit](../wartung-und-betrieb/daten-sichern-und-wiederherstellen/index.md) before using a hotfix.
