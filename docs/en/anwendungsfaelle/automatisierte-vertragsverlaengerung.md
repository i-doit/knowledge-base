...
To apply the `extend-contracts` command, we need to use the [console](../automatisierung-und-integration/cli/index.md).
...
The path to the [console](../automatisierung-und-integration/cli/index.md) must be specified in full, along with the **username** and **password** of the i-doit instance user.
