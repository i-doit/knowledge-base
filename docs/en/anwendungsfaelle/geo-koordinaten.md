...
If not already done, the geo coordinates of a location can be determined via various map and navigation services. The coordinates are stored in the [category](../grundlagen/struktur-it-dokumentation.md) **Location**. The two attributes **Latitude** and **Longitude** are available there.
