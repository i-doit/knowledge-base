...
In addition to the physical assignment of [objects](../grundlagen/struktur-it-dokumentation.md) to [locations](../anwendungsfaelle/standorte.md), workstations can be documented as a logical construct. The central element is the [object type](../grundlagen/struktur-it-dokumentation.md) **Workstation**.
...
An object of this type is assigned to a person via the [category](../grundlagen/struktur-it-dokumentation.md) **Logical Location**.
