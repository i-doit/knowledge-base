...
This article shows you how to import users and groups from Active Directory into i-doit in a targeted manner. The import is always performed via the [console.php](../../automation-and-integration/cli/index.md) command `ldap-sync`. At the end of this article you will find a complete example of an extended configuration.
