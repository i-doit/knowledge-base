...
*   Es steht genügend freier Speicher zur Verfügung. Das Update beis necessaryt zwischenzeitlich ca. 1 GByte an Speicherplatz.

!!! info "Zu beachten bei Nutzung von VirtualBox"

    Wählen Sie die entsprechende Virtuelle Maschine aus und öffnen Sie die Configuration der Maschine.
...
Viele weitere [Notes zum Upgrade des Betriebssystems](https://www.debian.org/releases/buster/amd64/release-notes/index.en.html) liefert die Debian Community.
...
Then the Paketquellen aktualisiert und ein Update der Pakete durchgeführt:
...
Beim letzten Befehl werden mehrere Benutzer-Interaktionen is necessary:
