...
description: The following backup script serves as an example of how a simple data backup can be set up.
icon:
status:
lang: en
---
...
The following backup script serves as an **example** of how a simple data backup can be set up. It does not replace a professional solution!

!!! danger "Use at your own risk"
    This script deletes files! Please use at your own risk! i-doit GmbH provides neither warranty nor support and excludes liability for consequential damages.
...
- [Maintenance and Operation](../index.md) -- Overview of maintenance and operation
- [installation](../../installation/index.md) -- Install i-doit
- [System Requirements](../../installation/systemvoraussetzungen.md) -- Hardware and software requirements
