---
title: Basics
description: "i-doit is installed and the first login is coming up?"
icon:
status:
lang: en
---
...
i-doit is [installed](../installation/index.md) and the first login is coming up? Here you will learn the basics -- from the user interface to objects and lists, all the way to the complete reference of all object types and categories.

## First steps

Start here if you are working with i-doit for the first time:

-   [Initial login](erstanmeldung.md) -- Your first login and the most important settings
-   [The i-doit interface](web-gui.md) -- Navigation, menus and work areas
-   [Dashboard and widgets](dashboard-und-widgets.md) -- Set up your personal start page
-   [Structure of IT documentation](struktur-it-dokumentation.md) -- How i-doit organizes information

## Objects and lists

Everything in i-doit is an object -- servers, switches, persons, contracts. Here you will learn how to work with objects:

-   [Object list](objekt-liste/index.md) -- Find, filter and edit objects
-   [Object relationships](objekt-beziehungen.md) -- How objects are linked to each other
-   [Life and documentation cycle](lebens-und-dokumentationszyklus.md) -- From planning to disposal
-   [Unique references](eindeutige-referenzierungen.md) -- IDs, SYSIDs and inventory numbers
-   [Logbook](logbuch.md) -- Who changed what and when?
...
-   [Category reference](kategorien/index.md) -- All categories in detail with API examples
