...
The specific category for this object type is [Net](../kategorien/s-net.md).
The specific category for this object type is [IP list](../kategorien/s-net-ip-addresses.md).
The specific category for this object type is [DHCP](../kategorien/s-net-dhcp.md).
The specific category for this object type is [Network Zone](../kategorien/s-net-zone.md).
