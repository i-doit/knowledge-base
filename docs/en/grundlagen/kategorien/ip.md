...
- **Combination with Access and Contact Assignment**: The Host Address provides the IP, the [Access](access.md) category the specific service URL, and the [Contact Assignment](contact-assignment.md) the responsible person. Together, they create a complete picture: *which* address, *how* reachable, *who* is responsible.
