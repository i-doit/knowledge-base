...
The user object that triggered the change. For API access, the API user is shown here; for manual changes, the logged-in user. In combination with the [rights management](../../effizientes-dokumentieren/rechteverwaltung/index.md), you can verify whether the user had the necessary permission for the change.
