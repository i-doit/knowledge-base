...
| Create new object of a type in object list | Display object in object list;<br><br>Activate quick info with mouseover | Create new [object of a type](/display/en/Structure+of+the+IT+Documentation) | [Archive and restore](/display/en/Life+and+Documentation+Cycle) object type | Mark object of a type as [deleted](/display/en/Life+and+Documentation+Cycle) and restore | –   | Delete object of a type irrevocably (`**purge**`) | `**Object(s) of type**` | Select one, several or all object types |
