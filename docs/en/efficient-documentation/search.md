...
Targeted research in the [IT documentation](../glossary.md) is often the fastest way to reach your goal -- faster than navigating through menu structures.
...
*   If the search begins with a hash followed by the [object ID](../glossary.md) (#123), pressing the Return key opens the overview page of the object with that ID.
...
The [i-doit console utility](../automation-and-integration/cli/index.md) also allows you to search via the command line:
