...
When a user edits an [object](../basics/it-documentation-structure.md), it is locked for a certain time for other users. During this time, they can view the object in read mode but cannot edit it. The object lock is indicated by a large, red notice appearing on the [overview page](../basics/it-documentation-structure.md) and in every [category](../basics/it-documentation-structure.md) of the locked object, showing who locked the object: **- LOCKED ([User]) -**
