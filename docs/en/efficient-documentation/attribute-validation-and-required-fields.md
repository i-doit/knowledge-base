...
If you want to ensure the uniqueness of [attributes](../glossary.md), expect only defined values when maintaining certain fields, or want to make fields mandatory, i-doit provides the corresponding functions.
...
*   Definition of uniqueness of the field value per [object](../basics/it-documentation-structure.md) ([list category](../basics/it-documentation-structure.md))/[object type](../basics/it-documentation-structure.md)/[tenant](../glossary.md) (global)
...
Furthermore, you can specify whether the attribute must be unique in your [IT documentation](../basics/it-documentation-structure.md), i.e., may only exist once at most. This is done via the following buttons:
