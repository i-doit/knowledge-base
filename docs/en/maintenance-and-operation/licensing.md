...
Licensing of i-doit and add-ons is done via a license token. The license token is sent by email. If you can no longer find your license token, please refer to the article [Find or reset the license token](../administration/reset-token.md).

* * *

## How Do I Obtain the License Token and the Offline License?

!!! hint "If you are evaluating i-doit, please contact us via [help.i-doit.com](https://help.i-doit.com){: target="_blank" } or <mailto:help@i-doit.com> to obtain the **offline license**"

The **license token** is sent by email. The **offline license** can be retrieved from the [customer portal](../administration/customer-portal.md) at <https://center.i-doit.com/portal/advanced>.

* * *

-   [How do I activate the i-doit eval/trial when i-doit **has internet access**?](#how-do-i-activate-the-i-doit-evaltrial-online)
-   [How do I activate the i-doit eval/trial when i-doit **has no internet access**?](#how-do-i-activate-the-i-doit-evaltrial-offline)

-   [How do I change or update the i-doit license token when i-doit **has internet access**?](#how-do-i-change-or-update-the-i-doit-license-token-online)
-   [How do I change or update the i-doit license token when i-doit **has no internet access**?](#how-do-i-change-or-update-the-i-doit-license-token-offline)
...
!!! attention "Token Compatibility"
    The license token can be used from **i-doit version 1.12.2** onwards.
    The offline license can only be used from **i-doit version 1.15** onwards.

!!! info "Re-login required"
    When a license is successfully installed, it may still happen that a notice appears while continuing to work with i-doit stating that no valid license is activated. In this case, logging out and logging back in with the current user helps.

### Firewall Rules to Use the Add-on & Subscription Center in i-doit

To use the Add-on & Subscription Center in i-doit, some firewall rules may be required. Which hostnames and IP addresses i-doit uses is described in the article [Security and Protection](../maintenance-and-operation/security-and-protection.md#firewall-and-network).
