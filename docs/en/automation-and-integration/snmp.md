...
!!! info ""
    This article was last checked for i-doit version 1.18.2
...
Afterwards, you have to assign the SNMP category to the desired object type with the [Edit data structure](../system-administration/administration/data-structure/edit-data-structure.md). In our example we only used the **Switch** object type.
...
```shell
sudo apt-get install snmpsnmpwalk -v 2c -c public 192.168.10.1 1.3.6.1.2.1.2.2.1.1
```
