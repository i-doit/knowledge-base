...
| **[nagios](../monitoring/nagios.md)****                                           | yes         | yes          | –                                                        | Write the actual status from network monitoring into logbook                            |
| **[nagios_export](../monitoring/nagios.md)**                                      | yes         | yes          | –                                                        | Export Nagios configuration                                                             |
