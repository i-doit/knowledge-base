...
We recommend using a dedicated virtual machine. The actual hardware requirements depend on the scope of the [IT documentation](../glossary.md) and the number of concurrent users.
