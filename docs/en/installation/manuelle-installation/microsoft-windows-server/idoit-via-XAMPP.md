...
The [system requirements](../../systemvoraussetzungen.md) of the respective i-doit version must be observed. Therefore, in this example, the installation package → xampp-windows-x64-8.2.12-0-VS16-installer.exe with PHP 8.2, which has been supported since i-doit 30, is used.
...
Now we download i-doit in the latest version from the [customer portal](../../../administration/kundenportal.md).<br>
