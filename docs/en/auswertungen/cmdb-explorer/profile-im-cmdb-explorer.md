...
To customize the view, you can create profiles in the [CMDB Explorer](../../auswertungen/cmdb-explorer/index.md) that provide you with the best possible overview of the dependencies in your [IT documentation](../../glossar.md#it-dokumentation).
