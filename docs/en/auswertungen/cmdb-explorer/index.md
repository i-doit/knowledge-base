...
You can access the CMDB Explorer both via the menu bar at the top and within an [object](../../grundlagen/struktur-it-dokumentation.md) via the corresponding icon above the [category](../../glossar.md#kategorie) list.
...
The content area of the CMDB Explorer is located centrally. All content matching your settings in scope and presentation can be found here. The form of presentation can be defined via [profiles](../../auswertungen/cmdb-explorer/index.md).
...
The information area is located on the left side of the CMDB Explorer and displays additional information about the selected object. Which information is displayed can be defined via the profile used for the CMDB Explorer. When an object is activated, the **Show/hide object type** button can be used to gray out all [objects of this type](../../grundlagen/struktur-it-dokumentation.md) for a better overview.
...
In the toolbar above the content area, the object to be displayed centrally and around which the relationships are built is selected. Additionally, it is possible to select the [profile](../../auswertungen/cmdb-explorer/profile-im-cmdb-explorer.md) for the display. In the default state, a **Micro Profile** is offered alongside the **default Profile**, which allows the display of more information in a smaller area.
