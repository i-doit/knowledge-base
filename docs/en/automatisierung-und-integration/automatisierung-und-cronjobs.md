...
Fill the file with commands from the [i-doit console utility](../automatisierung-und-integration/cli/index.md). Example content:
...
If you also want to automate the [JDisc import](../automatisierung-und-integration/cli/index.md) or [LDAP sync](../automatisierung-und-integration/cli/index.md), add the corresponding commands in the same format to the batch file.
