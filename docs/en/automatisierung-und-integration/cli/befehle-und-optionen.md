...
| [ldap-sync](#ldap-sync)                                                   | Import persons and person groups from an [LDAP directory or Active Directory (AD)](../../benutzerauthentifizierung-und-verwaltung/ldap-verzeichnis/index.md) |
...
| [notifications-list](#notifications-list)                                 | Lists all [notifications](../../auswertungen/benachrichtigungen.md)                                                                                             |
...
Lists all [notifications](../../auswertungen/benachrichtigungen.md)
