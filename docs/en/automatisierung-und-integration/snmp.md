...
2. Assign the SNMP category to the desired object type via [Edit Data Structure](../administration/verwaltung/datenstruktur/datenstruktur-bearbeiten.md) (in this example: Router).
