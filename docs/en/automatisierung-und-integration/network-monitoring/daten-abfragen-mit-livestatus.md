...
1. Assign the [category folder](../../grundlagen/struktur-it-dokumentation.md) **Monitoring** to the desired [object types](../../grundlagen/struktur-it-dokumentation.md) via **[Edit Data Structure](../../administration/verwaltung/datenstruktur/datenstruktur-bearbeiten.md)**.
2. Configure the [identification key](../../grundlagen/eindeutige-referenzierungen.md) for each [object](../../grundlagen/struktur-it-dokumentation.md) in the **Monitoring** category. You can use the object title, the hostname (with or without domain), or a freely chosen name.
...
Additionally, you can add a column for NDO or Livestatus in the [object list configuration](../../grundlagen/objekt-liste/listenansicht-konfigurieren.md) to display the host status directly in the [object list](../../grundlagen/objekt-liste/index.md).
...
With the [i-doit console utility](../cli/index.md), you transfer status messages from monitoring into the [logbook](../../grundlagen/logbuch.md) of i-doit. Call the `nagios-ndoutils` command for this -- it automatically transfers all status changes since the last run.
