...
:material-arrow-right: Details on configuration: [Using INI files](../../automation-and-integration/cli/configuration-files.md)
...
If the import exceeds the default `memory_limit` of **2G**, the following value can be set in the [Expert Settings](../../administration/management/tenant-management/expert-settings.md#liste-der-einstellungen):
...
* [i-doit console utility Import](../../automation-and-integration/cli/index.md)
* [Using INI files](../../automation-and-integration/cli/configuration-files.md)
