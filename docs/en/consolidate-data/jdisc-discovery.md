...
The i-doit default installation already provides a predefined example profile. The **Example** profile has the purpose to import all data in i-doit which have been inventoried by JDisc.
