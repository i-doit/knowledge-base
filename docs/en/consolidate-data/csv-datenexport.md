...
You can export data directly from the [IT documentation](../glossary.md) in CSV format and process it further in a spreadsheet application. Three methods are available.

## Exporting Object Lists

Open the [object list](../basics/object-list/index.md) and click the **CSV** button in the action bar. The exported columns correspond to the [configured attributes of the list view](../basics/object-list/configure-list-view.md).
...
The CSV export supports many [category lists](../glossary.md) (multi-value). Click the **CSV** button within a category list to download all entries and [attributes](../glossary.md).
