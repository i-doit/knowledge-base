...
This example builds on the [CSV import of applications](csv-import-example-applications.md). You import licenses with all relevant key and runtime information.
