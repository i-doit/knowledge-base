After you’ve met the [requirements](/pages/viewpage.action?pageId=75989128) download the latest stable version of the i-doit pro add-on from the [i-doit customer portal](https://login.i-doit.com/).
