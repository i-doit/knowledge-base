...
### Missing constant causes error for update migration

??? note "While update step 6 you get this error message"
...
[i-doit_30_update-patch.zip :material-file-download:](../../../assets/downloads/hotfixes/29/i-doit_30_update-patch.zip){ .md-button .md-button--primary }
