...
3. [Automated access from third-party systems](../automation-and-integration/index.md) should be deactivated.
4. [Cron jobs](../automation-and-integration/cli/index.md) should also be deactivated. It is usually sufficient to comment out the command lines.
...
5. [**Backups**](../maintenance-and-operation/backup-and-restore/index.md) should be set up and tested.
6. If the WebGUI also responds as usual and all data in i-doit is apparently present, the migration was **successful**.
7. Perform standard [security measures](../maintenance-and-operation/security-and-protection.md).
