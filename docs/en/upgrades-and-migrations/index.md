...
*   [Update Guide from i-doit 1.7.4 to 31](./update-guide.md)
*   [Update of i-doit open 1.4.8 to 1.8](./update-of-i-doit-open-1.4.8-to-1.8.md)
*   [Upgrade from i-doit open to i-doit](./upgrade-from-open-to-i-doit.md)
*   [Upgrade to MySQL 5.6 or MariaDB 10.0](./upgrade-to-mysql-5.6-or-mariadb-10.0.md)
*   [Update PHP and MariaDB for idoit Windows](./update-php-and-mariadb-idoit-windows.md)
