...
i-doit stores most content and settings in a Database Management System (DBMS). [MySQL or MariaDB](../../installation/systemvoraussetzungen.md) are used as the DBMS. But how is the database model of i-doit structured?
