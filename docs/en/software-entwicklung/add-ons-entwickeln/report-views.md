...
We can use the [TOM logic](./kategorien-programmieren.md#ubergabe-der-daten-an-smarty-plugins-mittels-tom-und-rules) here, similar to categories -- in the example add-on, we use this method to prepare the status filter.
...
Once this step is done and the Report View class is available via autoloading, the [Report View can be opened in i-doit](../../auswertungen/report-manager.md#report-views) and executed.
