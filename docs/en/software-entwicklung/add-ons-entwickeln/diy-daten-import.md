...
How this works is explained in the next section. The articles [Programming Categories](./kategorien-programmieren.md) and [Attribute Definition](./attribut-definition.md) will help with understanding!
