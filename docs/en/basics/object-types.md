The default installation of i-doit already offers a large variety of [object types](/display/en/Structure+of+the+IT+Documentation) which can be used for a wide range of purposes or can be hidden when they are not used. This article provides a short overview of object types.
...
| `**information domain**` | Information networks (IT security/ IT-Grundschutz); see [Add-on VIVA](/display/de/VIVA) |     |
