i-doit provides over 200 predefined [categories](/display/en/Structure+of+the+IT+Documentation). The result is a wide range of over 1,000 [attributes](/display/en/Structure+of+the+IT+Documentation) which theoretically can be documented for each [object](/display/en/Structure+of+the+IT+Documentation). This abundance inevitably leads to the frequently asked question "What is the purpose of category XY with all its attributes?" Which concepts represent each single category and each single attribute?
...
| Category | Attribute | Description |
| --- | --- | --- |
| **`All tickets ![](/download/attachments/61015928/comments.png?version=1&modificationDate=1493717798685&api=v2)`** | **`-`** | [Service Desk](/display/en/Service+Desk): If the interface to the service desk is activated, you can display all referenced tickets for this object with this category. |
| **`General  <br>`** | **`ID`** | Each object receives a [unique identifier (ID)](/display/en/Unique+References) by the underlying DBMS MySQL/MariaDB. |
...
|     | **`Status  <br>`** | The [life cycle of the documentation](/display/en/Life+and+Documentation+Cycle) is mapped via the **`Status`**. |
|     | **`CMDB status  <br>`** | The CMDB status indicates the [stadium of the life cycle](/display/en/Life+and+Documentation+Cycle) of an object, for example, `**in operation**`. |
...
|     | **`SYSID`** | Beside the `**Object ID**`, the `**SYSID**` is suited for [unique referencing](/display/en/Unique+References). Additionally, the user can edit the SYSID while the `**Object ID**` is fixed. |
...
| **`Analysis ![](/download/attachments/61015928/chart_pie.png?version=1&modificationDate=1493717798818&api=v2)`** | **`-`** | Forwards you to the impact simulation of the [Analysis](/display/en/Analysis) add-on. |
...
| ``**`**Relationship**` ![](/download/attachments/61015928/arrow_out.png?version=1&modificationDate=1493717798945&api=v2)**`` | **`-`** | List of all [object relations](/display/en/Object+Relations) |
...
| `**CMDB explorer**` ![](/download/attachments/61015928/chart_organisation.png?version=1&modificationDate=1493717798849&api=v2) | \-  | Opens the object in the [CMDB explorer](/display/en/CMDB+Explorer) |
...
| `**Relation details**` | \-  | Details about an [object relation](/display/en/Object+Relations) |
...
| `**Parallel relations  <br>**` | \-  | Information about a parallel [object relation](/display/en/Object+Relations) |
