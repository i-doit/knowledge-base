...
Via the "Edit data structure" function, you control which [object type groups](../glossary.md), [object types](../glossary.md) and [categories](../glossary.md) are active and assigned to each other in your i-doit installation.
...
Via the **Create custom category** button, you can go directly to creating [custom categories](custom-categories.md).
