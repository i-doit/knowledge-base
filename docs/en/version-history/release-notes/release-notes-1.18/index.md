...
You should [update](../../../maintenance-and-operation/i-doit-update.md) to the latest version to benefit from these changes.

Highlights in this release
--------------------------

*   New **crypto hashing** for user passwords to **increase security**.
*   A **configuration** for your own **[custom counter-placeholders](../../../administration/management/predefined-content/custom-counters.md)** to gain control over multiple different counters at the same time.
