...
We're happy to announce our latest major version 1.19 of i-doit. This release is a very important step in the development of i-doit. See the changelog for a complete list of changes. We encourage you to [update](../../maintenance-and-operation/i-doit-update.md) to this release as soon as possible.
...
*   **Setting** to define a [**default language** for newly created users](../../administration/management/tenant-management/tenant-settings.md#sprache).
*   **New configuration** to **[attribute settings](../../administration/management/data-view/attribute-settings.md)** from categories and/or overview pages.
*   **Option** to **log** the **[last login](../../administration/management/tenant-management/tenant-settings.md#sicherheit)** of a user.
*   [**Export** for **reports**](../../evaluation/report-manager.md#exportingimporting-reports) which have been created via **query builder**.
...
*   The following **Partner Add-ons** need to be updated **before** the i-doit 1.19 update (If these version requirements are not matched, the i-doit update cannot be performed):
    ...
    *   **[VIVA 2](../../i-doit-add-ons/viva2/index.md)** needs to be updated to version **3.2.1 or higher**
...
Please check that your system matches the [system requirements](../../installation/system-requirements.md) before updating your instance to i-doit 1.19. Please also check that you have created a [backup of all your data](../../maintenance-and-operation/backup-and-restore/index.md) and all add-ons are [up-to-date](../../i-doit-add-ons/index.md).
