...
>
> Instructions and notes on updating the database system can be found in our Knowledge Base at: [Upgrade to MySQL 5.6 and MariaDB 10.0](../../upgrades-and-migrations/upgrade-zu-mysql-5.6-oder-mariadb-10.0.md)
>
