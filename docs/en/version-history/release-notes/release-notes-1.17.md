...
The update to this new version [works as usual](../../maintenance-and-operation/i-doit-update.md). We slightly adjusted the [system requirements](../../installation/system-requirements.md):
...
Before you update ensure all system requirements are met and you've made a [backup of all your data](../../maintenance-and-operation/backup-and-restore/index.md).
