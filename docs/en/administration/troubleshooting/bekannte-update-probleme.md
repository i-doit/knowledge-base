...
If you have installed the hotfix [i-doit_28_hotfix_ID-10745.zip](../hotfixes/hotfix-archiv/v28.md#wrong-i-doit-version-is-downloaded-at-updater), the new version is displayed. However, clicking **Next** has no effect. The following error message appears in the browser's developer console (F12):
<!-- cSpell:disable -->
```shell
...
2. Download the update ZIP for version **29** from the [Customer Portal](../kundenportal.md).
3. Extract the ZIP in the i-doit folder, as [described here](../../wartung-und-betrieb/update-einspielen.md#update-uber-die-konsole-vorbereiten).
...
-   Use the appropriate hotfix from the [Hotfix Archive](../hotfixes/hotfix-archiv/index.md).
