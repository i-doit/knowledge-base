...
i-doit cannot access the desired [tenant database](../../software-entwicklung/datenbank-modell/index.md). This error frequently occurs when an i-doit installation is moved to a different system and the MySQL/MariaDB users do not exist on the new system.
