...
This problem frequently occurs when a large number of location assignments have been created by an automated process (e.g., a [data import](../../consolidate-data/index.md)).
