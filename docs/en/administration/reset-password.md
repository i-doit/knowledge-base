...
2. **Reset password** is enabled in the [Settings for [Tenant Name]](./management/tenant-management/tenant-settings.md)
...
2. Navigate to **Administration** and open the [Settings for [Tenant Name]](management/tenant-management/tenant-settings.md)
