...
This hotfix provides a new command for the [console.php](../../automation-and-integration/cli/index.md) that allows you to set a new encrypted password for the Admin Center:
