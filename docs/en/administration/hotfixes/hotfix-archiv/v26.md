...
!!! info "Currency"
    The system requirements listed below refer to the current version of i-doit, in this case ==26==. These specifications are updated with each i-doit release. If you need the specifications for older versions of i-doit, you can follow the change history of this page.
