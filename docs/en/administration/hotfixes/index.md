...
Hotfixes for older versions can be found in the [Hotfix Archive](hotfix-archive/index.md).

!!! tip "Recommendation"
    Only apply hotfixes if they are necessary for the proper operation of your installation or if support requests you to do so. Always create a [backup of i-doit](../../maintenance-and-operation/backup-and-restore/index.md) beforehand. If you contact support after applying a hotfix, please mention that you have done so.
