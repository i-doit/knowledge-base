...
!!! bug "Hotfix release"
    ...
    !!! example "**or download and extract the package**"
        -   Download the new package from the [customer portal](../../../administration/customer-portal.md)
        -   Extract the package into the i-doit Folder, see [here](../../../maintenance-and-operation/i-doit-update.md#update-uber-die-konsole-vorbereiten)
        -   Set file and folder rights, either via `idoit-rights.sh` or [manual](../../../installation/manual-installation/setup.md)
