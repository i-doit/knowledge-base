...
description: "The Customer Portal is the central hub for i-doit users."
icon:
status:
lang: en
---
...
The Customer Portal is the central hub for i-doit users. Here you can find [installation packages](../installation/index.md), the currently valid [offline license](../maintenance-and-operation/licensing.md) for download, as well as an overview of your subscription and purchased products (e.g., [i-doit add-ons](../i-doit-add-ons/i-diary.md)).

You can reach the Customer Portal at:

**[Add-on & Subscription Center](https://center.i-doit.com/)**

To log in, you need your license token. You receive this during the ordering process.
