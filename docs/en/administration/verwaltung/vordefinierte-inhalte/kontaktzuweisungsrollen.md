...
description: "In i-doit, contact assignment roles provide the ability to define the type of function during contact assignment."
icon:
status:
lang: en
---
...
Under **Administration → Predefined Content → Contact Assignment Roles**, you manage the roles that can be assigned during contact assignment to an object. This defines in which function a person or person group is associated with an object -- for example, as Administrator, User, or Owner.
...
- [CMDB Status](cmdb-status.md) -- Predefined status values for objects
- [Life and Documentation Cycle](../../../grundlagen/lebens-und-dokumentationszyklus.md) -- Overview of conditions and statuses in i-doit
