...
The visibility of [attributes](../../../grundlagen/attributfelder.md) can be adjusted in the attribute settings.
It is possible to show or hide specific attributes in [categories](../../../grundlagen/kategorien-und-attribute.md) and/or on the [overview page of object types](../../../grundlagen/objekttyp-konfiguration.md).
...
[Permissions](../berechtigungen.md) to view and edit attribute visibility can be assigned per user (group). For example, it is possible and often advisable that only certain user groups can hide attributes.
