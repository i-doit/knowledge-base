...
The LDAP connection is used for user authentication and automatic synchronization of persons and person groups to i-doit. You can set up multiple LDAP servers to connect different directory services or domains. Detailed documentation on LDAP configuration can be found under [LDAP Directory](../../../../benutzerauthentifizierung-und-verwaltung/ldap-verzeichnis/index.md).
