...
- In the [Expert Settings](expert-settings.md), you can find the option `cmdb.refresh-table-configurations`, which allows you to reset object list configurations — helpful when lists are not displayed correctly after an update.
