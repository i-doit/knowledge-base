...
A more comprehensive introduction to the topic can be found in the use case [IP Address Management (IPAM)](../use-cases/ip-adress-management.md).

## IP List Category

A comprehensive overview of each network is provided by the [category](../basics/it-documentation-structure.md) **IP List**, which is assigned to the [object type](../basics/it-documentation-structure.md) **Layer 3 Net** in the standard installation of i-doit. A tabular list contains all [objects](../basics/it-documentation-structure.md) assigned to this network, along with IP address, hostname, and type of address assignment.
