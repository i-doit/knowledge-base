...
Let [JDisc Discovery](../consolidate-data/jdisc/index.md) or a [CSV import](../consolidate-data/csv-data-import/index.md) do the work. Import existing data from network scans or Excel lists and then enrich them in i-doit.
...
|---|---|---|
| Excel/CSV | [CSV data import](../consolidate-data/csv-data-import/index.md) | Locations, contacts, clients, any lists |
| Network scan | [JDisc Discovery](../consolidate-data/jdisc/index.md) | Servers, switches, printers, software |
| LDAP/AD | [LDAP directory](../user-authentication-and-management/ldap-directory/index.md) | Users and groups |
...
-   **Automatically or manually?** — Regular JDisc scans and [cronjobs](../automation-and-integration/cli/index.md) keep many things automatically up to date.
...
-   [First login](../basics/initial-login.md) — Your first login
-   [Basics](../basics/index.md) — Understand objects, categories, and attributes
