...
For reading or editing a category.
...
Create a new [category](../../../../basics/categories-and-attributes.md) entry
...
Read one or more [category](../../../../basics/categories-and-attributes.md) entries for an object
...
!!! note ""
    Even if it is a [single-value category](../../../../basics/categories-and-attributes.md) or a [multi-value category](../../../../basics/categories-and-attributes.md) with only 1 entry, the JSON key **result** contains always an array of JSON objects.

| Key       | JSON data type | Description                                                     |
| --------- | -------------- | --------------------------------------------------------------- |
| **id**    | String         | Entry identifier (as numeric string)                            |
| **objID** | String         | Object identifier (as numeric string)                           |
| …         | Mixed          | Optionally attributes with values depending on requested category |
...
Archive a category entry for an object, mark it as deleted or purge it from database. See also [documentationszyklus](../../../../basics/life-and-documentation-cycle.md)
