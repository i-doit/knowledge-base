...
Fetch a list of [objects](../../../../basics/it-documentation-structure.md)
...
| **liwith**      | Mixed          | No       | Maximum amount of objects (as integer), for example, fetch the first thousand of objects: **1000**<br><br>Combine this liwith with an offset (as string), for example, fetch the next thousand of objects: **"1000,1000"**                         |
...
| **updated**           | String         | Date of last update; format: **Y-m-d H:i:s**<br><br>**Note:** This key is optionally because not every object has been updated before.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **categories**        | Mixed          | Optionally attributes with values depending on the requested category                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
