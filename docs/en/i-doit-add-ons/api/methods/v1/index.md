...
??? example "cmdb.object.archive (Click to expand)"
    ...
    [Archive](../../../../basics/life-and-documentation-cycle.md) an object
...
??? example "cmdb.object.purge (Click to expand)"
    ...
    [Purge](../../../../basics/life-and-documentation-cycle.md) an object
...
??? example "cmdb.object.markAsTemplate (Click to expand)"
    ...
    Set the object state to [Template](../../../../efficient-documentation/templates.md)
...
??? example "cmdb.object.markAsMassChangeTemplate (Click to expand)"
    ...
    Set the object state to [Mass change](../../../../efficient-documentation/mass-change.md) [Template](../../../../efficient-documentation/templates.md)
...
??? example "cmdb.category.create (Click to expand)"
    ...
    | **category** | String        | Yes          | [Category constant](../../../../basics/categories-and-attributes.md), for example: **C__CATG__MODEL**                 |
...
??? example "cmdb.category.quickpurge (Click to expand)"
    ...
    If [Quickpurge](../../../../basics/object-list/advanced-settings.md) is enabled, you can purge a category entry of an object directly from the database.
...
??? example "cmdb.dialog.update (Click to expand)"
    ...
    Update a [dialog entry](../../../../basics/dialog-admin.md)
