...
To make working with the [programming interface (API)](../../administration/management/add-ons/json-rpc-api/index.md) of i-doit easier, we have compiled some typical examples.
...
??? example "cmdb.category.create"
    ...
    The special feature here is the attribute pair **Manufacturer** and **Model**, which are interdependent. Since both are [Dialog+ fields](../../basics/attribute-fields.md), the names can be passed as strings. If matching entries do not yet exist, they will be created.
