...
Before running [push](./generate-wato-configuration.md) or [pull](./import-inventory-data.md), you may want to take a closer look at how your infrastructure looks in the two tools i-doit and Checkmk 2.
...
The [fetch-objects and fetch-hosts](./read-information-from-i-doit-and-checkmk.md) commands give you detailed information about your documented objects in i-doit or your monitored hosts in Checkmk 2. But neither reconciles them with each other. This is done by the match command:
