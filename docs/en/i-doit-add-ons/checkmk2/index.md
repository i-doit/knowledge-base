...
-   [Usage](./usage.md)
-   [Generate WATO Configuration Based on CMDB Data](./generate-wato-configuration.md)
-   [Import Inventory Data into the CMDB](./import-inventory-data.md)
-   [Match Objects from i-doit with Hosts from Checkmk](./match-objects-with-checkmk-hosts.md)
-   [Read Information from i-doit and Checkmk](./read-information-from-i-doit-and-checkmk.md)
-   [Import Agent Types from Checkmk to i-doit](./synchronize-checkmk-agents.md)
