...
1.  [Preparing the VIVA installation](./vorbereitung-der-viva-installation.md): The IT documentation in i-doit contains objects (including location and software assignments as well as port connections, where possible) that are modeled into services and should be covered by IT-Grundschutz.
2.  Managing IT-Grundschutz catalogs
    1.  [Import IT-Grundschutz catalog EL 15 from 2016](./vorgehensweise-mit-viva.md)
    2.  Customize modules, measures, and threats (optional)
3.  Model information domain with target groups and target objects
    1.  [Create information domain](./vorgehensweise-mit-viva.md)
...
4.  Determine protection needs
    1.  [Customize protection needs categories](./vorgehensweise-mit-viva.md)
...
5.  Assign modules and implement measures
    1.  [Assign the necessary modules per target group](./vorgehensweise-mit-viva.md)
    2.  [Document the implementation of measures per target group](./vorgehensweise-mit-viva.md)
    3.  [Answer audit questions](./vorgehensweise-mit-viva.md)
6.  Perform risk analysis
    1.  [Perform supplementary security analysis](./vorgehensweise-mit-viva.md)
    2.  [Perform risk analysis if applicable](./risikoanalyse-nach-it-grundschutz.md)
7.  Create audit
    1.  [Review reports](./berichte-mit-viva.md) and if applicable repeat steps 2-5 until reports no longer yield unavoidably negative results
    2.  Enter information for [reference document A.0](./audits-mit-viva-unterstuetzen.md) and [A.1](./audits-mit-viva-unterstuetzen.md)
    3.  [Create audits](./audits-mit-viva-unterstuetzen.md)
