...
Each `JDisc type` is linked with an `i-doit object type`  If no `i-doit object type` is selected, the item will not be imported. The [Import Matching Profile](../../administration/verwaltung/import-und-schnittstellen/import-matching-profile.md) is configured in the [Administration](../../administration/verwaltung/index.md) under `Import and Interfaces > Import Matching Profile`. Via the [Import Matching Profile](../../administration/verwaltung/import-und-schnittstellen/import-matching-profile.md) you can for example filter whether objects are imported that do not have certain attributes.
...
| General                                                                            | Description                                                                                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Select categories**                                                             | Which [categoryn](../../grundlagen/kategorien-und-attribute.md) should be populated during import? Only categories that the import can handle are listed.                                                                                           |
...
| **Consider default templates from object types (only for newly created objects)** | When a new object is created, the [Template](../../effizientes-dokumentieren/templates.md) stored in the object type is automatically applied.                                                                                                           |
| **Change CMDB status of objects to**                                               | Existing objects can receive a specific **[CMDB-Status](../../grundlagen/lebens-und-dokumentationszyklus.md)** . If the **CMDB status** should not be changed, select **Keep CMDB status**. |
| **CMDB status for newly imported objects**                                          | Newly created objects can receive a specific **[CMDB-Status](../../grundlagen/lebens-und-dokumentationszyklus.md)** erhalten. If the **CMDB status** should not be changed, select **-**.                                               |
...
| **Use simple database modeling**                                                      | Should the new or the old [database logic](../../anwendungsfaelle/dokumentation-von-datenbanken.md) be used?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
