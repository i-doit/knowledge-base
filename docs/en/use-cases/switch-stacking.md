...
[![Stack members](../assets/images/en/use-cases/switch-stacking/2-sws.png)](../assets/images/en/use-cases/switch-stacking/2-sws.png)
...
[![Logical ports](../assets/images/en/use-cases/switch-stacking/3-sws.png)](../assets/images/en/use-cases/switch-stacking/3-sws.png)

Additionally, the logical port of another stack member can be assigned as the parent port of a port.

[![Logical ports](../assets/images/en/use-cases/switch-stacking/4-sws.png)](../assets/images/en/use-cases/switch-stacking/4-sws.png)
