...
Users in i-doit are a part of the IT documentation, therefore all users are an [object](/display/en/Structure+of+the+IT+Documentation) of the type `**Persons**`. To create a local user, you initially create a new `**Persons**` object.
