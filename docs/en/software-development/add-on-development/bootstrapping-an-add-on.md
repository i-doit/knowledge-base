...
The displayed settings for [tenant-name] under **Administration > [tenant-name] Administration > Settings for [tenant-name]** can be extended via an add-on. Further information on this can be found in the article [Extending System Settings](extend-system-settings.md).
