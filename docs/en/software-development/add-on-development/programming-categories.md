...
[more on that later](programming-categories.md#smarty-plugins).
...
"[Installing, Updating, and Activating Add-ons](install-update-activate-add-ons.md)".
...
[Here you can find additional information about our database tables.](../database-model/index.md)
