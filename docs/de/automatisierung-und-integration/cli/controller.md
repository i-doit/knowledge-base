...
| **[check_mk](../monitoring/daten-abfragen-mit-livestatus.md)**                            | ja           | ja            | -                                                        | Ist-Zustand aus dem Network Monitoring ins Logbuch schreiben                                         |
...
| **[nagios](../monitoring/daten-abfragen-mit-livestatus.md)**                              | ja           | ja            | -                                                        | Ist-Zustand aus dem Network Monitoring ins Logbuch schreiben                                         |
| **[nagios_export](../monitoring/nagios.md)**                                              | ja           | ja            | -                                                        | Nagios-Konfiguration exportieren                                                                     |
