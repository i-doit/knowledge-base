...
| `push` | Konfigurieren, wie [Daten von i-doit an checkmk übertragen](https://kb.i-doit.com/display/de/checkmk+2%3A+WATO+Konfiguration+auf+Basis+von+CMDB-Daten+generieren) werden sollen |
| `pull` | Konfigurieren Sie, wie [Daten von checkmk zu i-doit ziehen](https://kb.i-doit.com/display/de/checkmk+2%3A+Bestandsdaten+in+die+CMDB+importieren) |
...
Konfigurieren Sie, wie [Daten von i-doit an checkmk übertragen werden sollen](https://kb.i-doit.com/display/de/checkmk+2%3A+WATO+Konfiguration+auf+Basis+von+CMDB-Daten+generieren):
...
Konfigurieren Sie, wie [Daten von Check\_MK zu i-doit ziehen](/pages/viewpage.action?pageId=75989124):
