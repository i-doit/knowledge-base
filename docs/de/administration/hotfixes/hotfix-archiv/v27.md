...
!!! attention "Bitte beachten"
    Bitte nutze Hotfixes ausschließlich mit der genannten Version. In neueren Versionen werden diese bereits enthalten sein, sodass eine erneute Installation nicht notwendig ist.
    Solltest du eine ältere Version von i-doit nutzen, ist es notwendig, zuerst auf die aktuelle Version zu aktualisieren.<br>
    ...
    Da es sich hierbei um Hotfixes handelt, empfehlen wir, diese nur einzuspielen, wenn diese für den sauberen Betrieb deiner Installation notwendig sind oder du durch den Support zur Verwendung aufgefordert wirst. Bitte stelle sicher, dass vor der Verwendung dieser Hotfixes ein [Backup von i-doit](../../../wartung-und-betrieb/daten-sichern-und-wiederherstellen/index.md) erstellt wurde.<br>
...
!!! bug "Hotfix release"
    ...
    !!! example "**or download and extract the package**"
        ...
        -   Extract the package into the i-doit Folder, see [here](../../../wartung-und-betrieb/update-einspielen.md#update-uber-die-konsole-vorbereiten)
        -   Set file and folder rights, either via `idoit-rights.sh` or [manual](../../../installation/manuelle-installation/setup.md)
