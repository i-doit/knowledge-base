...
| **disabledUsersBehaviour**    | Kann auf **archive**, **delete** und **disable_login** gesetzt werden um Benutzer auf [archiviert bzw. gelöscht](../../grundlagen/lebens-und-dokumentationszyklus.md) zu setzen, deren Konto im Verzeichnis deaktiviert ist. Oder man deaktiviert nur den Login für diese Benutzer. Wird nur für Active Directory ausgewertet, OpenLDAP und NDS haben kein vergleichbares Kennzeichen.<br><br>(Default: **archive**)<br><br>Bsp.<br><br>disabledUsersBehaviour=archive                                                                                                                                                                                                                                                      |
...
| **ignoreUsersWithAttributes** | Diese Funktion hilft, eine Synchronisation unerwünschter Verzeichnisobjekte zu verhindern.<br><br>Die ignoreFunction wird gegen jedes hier gelistete Attribut ausgeführt. Der Benutzer wird nur übersprungen, wenn sie auf alle zutrifft.<br><br>Bsp.<br><br>ignoreUsersWithAttributes\[\] = "samaccountname"                                                                                                                                                                                                                                                                                                                                                                                                     |
