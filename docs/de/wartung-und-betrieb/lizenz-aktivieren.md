...
[![How-to-get-a-token](../assets/images/wartung-und-betrieb/activate-license/0.how-to-get-a-token.png)](../assets/images/wartung-und-betrieb/activate-license/0.how-to-get-a-token.png)
...
[![Admin-login](../assets/images/wartung-und-betrieb/activate-license/1.Login_admin.png)](../assets/images/wartung-und-betrieb/activate-license/1.Login_admin.png)
...
[![Admin-Center-login](../assets/images/wartung-und-betrieb/activate-license/2.login_admin_center.png)](../assets/images/wartung-und-betrieb/activate-license/2.login_admin_center.png)

**Schritt 3:** Nun sind wir im Admin-Center angemeldet und klicken auf den Reiter “Licenses”.

[![Admin-Center-home](../assets/images/wartung-und-betrieb/activate-license/3.admin-center-home.png)](../assets/images/wartung-und-betrieb/activate-license/3.admin-center-home.png)

**Schritt 4:** Hier können wir Ihren Weblicense Token aktivieren. Dazu kopieren wir den License Token in das Eingabefeld.

[![Admin-Center-license](../assets/images/wartung-und-betrieb/activate-license/4.admin-center-licenses.png)](../assets/images/wartung-und-betrieb/activate-license/4.admin-center-licenses.png)
...
[![License-save](../assets/images/wartung-und-betrieb/activate-license/5.admin-center-licenses-token.png)](../assets/images/wartung-und-betrieb/activate-license/5.admin-center-licenses-token.png)
...
[![offline-key](../assets/images/wartung-und-betrieb/activate-license/6-offline-token.png)](../assets/images/wartung-und-betrieb/activate-license/6-offline-token.png)

**Schritt 6:** Nachdem der Token gespeichert wurde klicken wir auf den "**Install new license**" Button.

[![offline-key-install](../assets/images/wartung-und-betrieb/activate-license/7.add-new-license-button.png)](../assets/images/wartung-und-betrieb/activate-license/7.add-new-license-button.png)

**Schritt 7:** Nun sehen wir das Feld in welches der gesamte **Offline License Key** hineinkopiert werden muss.[![license-file](../assets/images/wartung-und-betrieb/activate-license/8.add-new-license.png)](../assets/images/wartung-und-betrieb/activate-license/8.add-new-license.png)
...
[![license-file-insert](../assets/images/wartung-und-betrieb/activate-license/9.add-new-license-end.png)](../assets/images/wartung-und-betrieb/activate-license/9.add-new-license-end.png)

**Schritt 8:** Klicken Sie nun auf den “**Add license**”-Button.

[![license-file-add](../assets/images/wartung-und-betrieb/activate-license/10.add-new-license-save.png)](../assets/images/wartung-und-betrieb/activate-license/10.add-new-license-save.png)

Der License Token wird mit dem Offline License Key verifiziert und es werden alle damit verbundenen Lizenzen angezeigt.

[![license-overview](../assets/images/wartung-und-betrieb/activate-license/11.admin-center-licenses-token.png)](../assets/images/wartung-und-betrieb/activate-license/11.admin-center-licenses-token.png)
...
[![license-installation](../assets/images/wartung-und-betrieb/activate-license/12.i-doit-license.png)](../assets/images/wartung-und-betrieb/activate-license/12.i-doit-license.png)
...
!!! success "Öffne den Reiter Tenant im Admin Center und klicke auf **Save license settings**."
    ...
    [![tenant-licenses](../assets/images/wartung-und-betrieb/activate-license/13.png)](../assets/images/wartung-und-betrieb/activate-license/13.png)