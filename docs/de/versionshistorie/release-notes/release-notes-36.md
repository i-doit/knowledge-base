...
Stellen Sie sicher, dass Sie **die Add-ons und i-doit entsprechend aktualisieren**, damit Sie die [Anforderungen](../../installation/systemvoraussetzungen.md) für i-doit 36 erfüllen.
