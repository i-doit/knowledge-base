...
| **Report**                             | Zeigt einen Report an, dazu muss der Report im Feld Zusatz ausgewählt werden. Verwendet der Report in seinen Bedingungen einen Feldplatzhalter, läuft er im Kontext des Objekts, das du gerade geöffnet hast, siehe [Variable Reports](../anwendungsfaelle/variable-reports.md).                                                                                                                                              |
...
## Beziehung von der Gegenseite anzeigen

Ein Feld vom Typ [Objekt-Beziehung](objekt-beziehungen.md) in einer benutzerdefinierten Kategorie wird nur auf einer Seite gepflegt. Listet die Kategorie **Bereichsdrucker** am Objekttyp **Drucker** die Räume auf, die ein Drucker versorgt, zeigen die Raum-Objekte diese Zuordnung von sich aus nicht an.

Um die Beziehung von der Gegenseite sichtbar zu machen, legst du für den anderen Objekttyp (hier **Raum**) eine zweite benutzerdefinierte Kategorie mit einem einzigen Feld vom Typ **Report** an. Im Feld **Zusatz** wählst du einen Report aus, dessen Bedingung einen **Feldplatzhalter** für das aktuelle Objekt verwendet. Der Report läuft dann im Kontext des Objekts, das du gerade geöffnet hast, und listet zum Beispiel den Drucker auf, der diesem Raum zugeordnet ist. Ein Schritt-für-Schritt-Beispiel findest du unter [Variable Reports](../anwendungsfaelle/variable-reports.md).
