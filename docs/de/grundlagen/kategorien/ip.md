...
- **Kombination mit Zugriff und Kontaktzuweisung**: Die Hostadresse liefert die IP, die Kategorie [Zugriff](access.md) den konkreten Dienst-URL, und die [Kontaktzuweisung](contact.md) den Verantwortlichen. Zusammen ergibt sich ein vollständiges Bild: *welche* Adresse, *wie* erreichbar, *wer* zuständig.
