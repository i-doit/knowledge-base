...
| **Cluster -> Gemeinsamer Speicher** | \-  | Visualisierung und Statistiken zu Wirtssystemen und LUNs; ist im Kategorie-Ordner **Cluster** enthalten |
...
| **Lokaler Massenspeicher -> Raid-Verbund** | \-  | Dokumentation von Hardware- oder Software-RAIDs mit den verschiedenen Leveln (1, 5, 6, 10 usw.); ist im Kategorie-Ordner **Lokaler Massenspeicher** enthalten |
...
| **Stacking Portübersicht** | \- | Zeigt die Ports aller Switchmitglieder gebündelt an. Bei Klick auf einen Port wird dieser aufgerufen |
...
| **Virtuelle Maschine -> Virtuelle Geräte** | \-  | Zuordnung von virtuellen Geräten zu Hardwareressourcen des Wirtssystems aus den Bereichen **Netzwerk**, **Storage** und **Schnittstellen**; ist im Kategorie-Ordner **Virtueller Host** enthalten |
...
| **Virtueller Host -> Gastsysteme** | \-  | Zugeordnete virtuelle Maschinen zu einem Wirtssystem; ist im Kategorie-Ordner **Virtueller Host** enthalten |
