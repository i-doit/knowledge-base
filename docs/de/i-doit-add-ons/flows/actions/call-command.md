...
Die folgenden [Konsolenbefehle](../../../automatisierung-und-integration/cli/index.md) sind im Add-on verfügbar. Du kannst diese Funktionen anstelle eines Cronjobs verwenden.
...
| Option              | Beschreibung                                                                                                                                                                                                    |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **importFile**      | Gib den vollständigen Pfad zur Datei an. Wenn du die Datei zuvor für den CSV-Import hochgeladen hast, lautet der Pfad beispielsweise `/var/www/html/imports/1/title.csv`. Die `1` ist die Mandanten-ID. |
| **importProfileId** | Du musst zuvor ein CSV-Importprofil erstellen, siehe [Profil anlegen](../../../daten-konsolidieren/csv-datenimport/index.md#profil-anlegen).                                                                    |

## import-hinventory (nur on-prem)

| Option         | Beschreibung                                                                                                                         |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **importFile** | Gib den vollständigen Pfad zur Datei an. Zum Beispiel `/var/www/html/imports/1/title.xml`, wobei die `1` die Mandanten-ID ist. |
