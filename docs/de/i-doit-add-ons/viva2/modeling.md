...
description: Bausteine des Grundschutzkompendiums dem Informationsverbund und seinen Zielobjekten zuordnen
icon:
status:
lang: de
---
...
Bei der Modellierung des Informationsverbundes ordnest du die Bausteine des Grundschutzkompendiums dem Informationsverbund und seinen Zielobjekten bzw. Zielobjektgruppen zu. Unterschieden wird zwischen der Zuweisung von Prozessbausteinen am Informationsverbund und von (hauptsächlich System-)Bausteinen an Zielobjekten bzw. Zielobjektgruppen.
...
Für jeden verwendeten Baustein trägst du die Verantwortlichkeiten über die Kategorie "Kontaktzuweisung" ein.

## Reihenfolge

Über die Spalte "Reihenfolge" trägst du eine Bearbeitungsreihenfolge der Bausteine ein.

[<- Zurück](assessment-of-protection.md){ .md-button } · [IT-Grundschutz-Check ->](it-grundschutz-check.md){ .md-button .md-button--primary }
