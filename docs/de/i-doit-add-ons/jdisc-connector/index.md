...
| **Matching auf zugewiesene Objekttypen begrenzen**                                    | Begrenzt die Suche nach einem bereits vorhandenen Objekt auf die i-doit Objekttypen, die in der Objekttyp-Zuweisung dieses Profils verwendet werden (siehe oben). Ohne diese Option kann ein Device auch einem Objekt eines anderen Objekttyps zugeordnet werden, sofern das Objekt die Kriterien des [Import Matching Profils](../../administration/verwaltung/import-und-schnittstellen/import-matching-profile.md) erfüllt, etwa ein Objekt mit derselben Objekt-Bezeichnung. |
...
| **Alle Layer-3-Netze einbeziehen** -> **Layer-3-Filter**                    | Nur sichtbar wenn **Alle Layer-3-Netze einbeziehen**aktiviert ist. Gib den Bereich in den folgenden Formaten an: 127.0.0.1-127.0.10.255 oder 10.40.55.0/24 oder 10.40.55.7. Eine Regel pro Zeile.                                    |
...
|                           | --ipFilter[=IPFILTER]               | IP-Filter, verwendest du eine durch Kommas getrennte Zeichenfolge oder eine durch Zeilenumbrüche getrennte Datei mit Adressen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| -u                        | --user=USER                         | Benutzername eines Benutzers, der berechtigt ist, die Ausführung durchzuführen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| -p                        | --password=PASSWORD                 | Passwort zur Authentifizierung des zuvor angegebenen Benutzers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| -i                        | --tenantId=TENANT-ID                | Mandanten-ID des zu verwendenden Mandanten (Standard: 1)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| -h                        | --help                              | Hilfemeldung zur Anzeige weiterer Informationen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
