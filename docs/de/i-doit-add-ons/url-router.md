...
`/open-object/server-abc`. Bitte beachten Sie, dass die Parameter [URL-codiert](https://de.wikipedia.org/wiki/URL-Encoding) übergeben werden sollten.
