---
title: "i-doit Appliance in eine Hyper-V Umgebung importieren"
description: Wir liefern unsere Appliance im OVF Format zusammen mit einem virtuellen VMDK Festplatten Image aus.
icon:
status:
lang: de
---
...
Hierfür kannst du das freie Tool "Starwind Converter" verwenden welches du unter dem folgenden Download Link herunterladen kannst:
...
Im nächsten Schritt können wir das Ziel für die neue VHD Festplatte und ihren Ordner auswählen und gehen auf "Next":
...
Hierfür starten wir den Hyper-V Assistenten für neue virtuelle Computer und geben den Ordner zur neu erstellten VHD an:
...
Gib dieser ausreichend Arbeitsspeicher ( [Systemvoraussetzungen](../systemvoraussetzungen.md) ) :
...
Die virtuelle Maschine sollte nun Ordnungsgemäß starten und du solltest dich mit den mitgelieferten Benutzerdaten anmelden können:
