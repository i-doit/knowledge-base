...
-   PHP läuft als **PHP-FPM** und wird über `mod_proxy_fcgi` an den Apache Webserver angebunden, so wie es auch das [idoit-install Skript](../automatische-installation.md) einrichtet. Das Apache-Modul mod_php wird nicht betrachtet.<br>
