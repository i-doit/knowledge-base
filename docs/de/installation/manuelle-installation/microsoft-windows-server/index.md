...
Vorab benötigen Sie ein gültiges Zertifikat im .crt und .key Format. Dieses können Sie sich mit openssl erstellen.<br>Openssl können Sie hier herunterladen:
...
Das Zertifikat und der Private Key wurden nun in dem Ordner erstellt, indem der Befehl ausgeführt wurde. Kopieren Sie diese am besten in den i-doit Ordner.
