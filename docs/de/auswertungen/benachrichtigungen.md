...
| **Schwellwert**                                 | Der Auslöser für die Benachrichtigung. Je nach Typ ist dies ein **zeitlicher Abstand** (z.B. 30 Tage) oder eine **Anzahl** (z. B. 5 Lizenzen). Eine genaue Erklärung wird direkt im Formular angezeigt. Ob die Übereinstimmung exakt sein soll, kann über die Option [Nur bei exakter Übereinstimmung des Schwellwerts benachrichtigen](../administration/verwaltung/mandanten-name-verwaltung/einstellungen-mandanten-name.md#benachrichtigungen) gesteuert werden. |
