...
| **Aktualisiere (Nur existierende Objekte)** | Mit dem Zusatz **"(Nur existierende Objekte)"** werden nur bestehende Objekte mit eneuen Daten aktualisiert. Es werden keine neuen Objekte erstellt. |
